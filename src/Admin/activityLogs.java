...
public class activityLogs extends javax.swing.JFrame {
    ...
    public void logActivity(String action,  int flightId) {
   Session sess = Session.getInstance();
    int userId = sess.getUid();

    String sql = "INSERT INTO tbl_logs (u_id, f_id, actions, f_date) " +
                 "VALUES (" + userId + ", " + flightId + ", '" + action.replace("'", "''") + "', NOW())";
    ...
    private void initComponents() {
        ...
        jLabel12.setForeground(new java.awt.Color(39, 39, 87));
        ...
        jLabel13.setForeground(new java.awt.Color(39, 39, 87));
    ...
    private void atableMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_atableMouseClicked
       int rowIndex= atable.getSelectedRow();
        ...
        if(rowIndex < 0){
            ...
            ResultSet rs = dbc.getData("SELECT*FROM tbl_logs WHERE l_id ='"+tbl.getValueAt(rowIndex, 0)+"'");
            if(rs.next()){
            lid.setText(""+rs.getInt("l_id"));
            uid.setText(""+rs.getString("u_id"));
            eid.setText(""+rs.getString("f_id"));
