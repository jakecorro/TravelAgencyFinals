...
public class bookingForm extends javax.swing.JFrame {
   ...
   public void displayData() {
    try {
        ...
        String query = "SELECT f_id, b_date, b_status FROM tbl_bookings WHERE u_id = " + userId;
    ...
    private void initComponents() {
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/person_23dp_F0F0F0_FILL0_wght400_GRAD0_opsz24.png"))); // NOI18N
        ...
        delete.setBackground(new java.awt.Color(39, 39, 87));
        ...
        add.setBackground(new java.awt.Color(39, 39, 87));
        ...
        update.setBackground(new java.awt.Color(39, 39, 87));
        ...
        jLabel4.setText("Flight Destination:");
...
if (eid.getText().isEmpty() || en.getText().isEmpty() || bdate.getText().isEmpty()) {
    ...
    dbConnector dbc = new dbConnector();
    int userId = sess.getUid();
    String flightId = eid.getText();
    String bookingDate = bdate.getText();
    String bookingStatus = es.getSelectedItem().toString();

    
    String sql = "INSERT INTO tbl_bookings(u_id, f_id, b_date, b_status) VALUES(" 
                 + userId + ", " 
                 + flightId + ", '" 
                 + bookingDate + "', '" 
                 + bookingStatus + "')";
    ...
    if (dbc.insertData(sql)) {
        ...
        String action = "User booked a flight with ID: " + flightId;
        activityLogs logger = new activityLogs();
        logger.logActivity(action, Integer.parseInt(flightId)); 
    }
